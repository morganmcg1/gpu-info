...
# Configure logging
log_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "gpu_info", "logs")
...
def process_video(api_key: str, video_url: str, output_dir: str) -> Dict[str, str]:
    ...
    cache_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "gpu_info", "cache")
...
def main():
    ...
    parser.add_argument("--output_dir", default=os.path.join(os.path.dirname(os.path.abspath(__file__)), "gpu_info", "output"), 
